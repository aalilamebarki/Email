...
const routers: RouterItem[] = [
  {
    "name": "faq.html",
    "title": "الأسئلة الشائعة — FAQ | FreeTemp.email — بريد مؤقت",
    "rel": "faq.html"
  },
  {
    "name": "guide.html",
    "title": "دليل الاستخدام — User Guide | FreeTemp.email — بريد مؤقت",
    "rel": "guide.html"
  },
  {
    "name": "about.html",
    "title": "من نحن — About Us | FreeTemp.email — بريد مؤقت",
    "rel": "about.html"
  },
  {
    "name": "privacy.html",
    "title": "سياسة الخصوصية — Privacy Policy | FreeTemp.email — بريد مؤقت",
    "rel": "privacy.html"
  },
  {
    "name": "blog.html",
    "title": "المدونة والأدلة — Blog & Guides | FreeTemp.email — بريد مؤقت",
    "rel": "blog.html"
  },
  {
    "name": "article.html",
    "title": "الدليل الشامل — Comprehensive Guide | FreeTemp.email — بريد مؤقت",
    "rel": "article.html"
  },
  {
    "name": "articles/index.html",
    "title": "فهرس المقالات الـ 22 — Articles Index | FreeTemp.email — بريد مؤقت",
    "rel": "articles/index.html"
  },
  {
    "name": "articles/universal-verification-coverage.html",
    "title": "التغطية الشاملة لرسائل التحقق (Universal Verification Coverage): فك شفرات OTP والروابط الخفية بدقة 100% | FreeTemp.email — بريد مؤقت",
    "rel": "articles/universal-verification-coverage.html"
  },
  {
    "name": "articles/how-inbox-updates-live.html",
    "title": "التحديث اللحظي عبر WebSocket: كيف تصل الرسائل إلى شاشتك خلال ميلي ثانية بدون إعادة تحميل؟ | FreeTemp.email — بريد مؤقت",
    "rel": "articles/how-inbox-updates-live.html"
  },
  {
    "name": "articles/temp-mail-vs-spam-filters.html",
    "title": "البريد المؤقت وفلاتر السبام: معايير SPF و DKIM و DMARC وكيف نتجاوز الحجب الصارم؟ | FreeTemp.email — بريد مؤقت",
    "rel": "articles/temp-mail-vs-spam-filters.html"
  },
  {
    "name": "articles/magic-links-vs-otp.html",
    "title": "روابط التفعيل السحرية (Magic Links) مقابل رموز OTP: أيهما أكثر أماناً وتوافقاً مع البريد المؤقت؟ | FreeTemp.email — بريد مؤقت",
    "rel": "articles/magic-links-vs-otp.html"
  },
  {
    "name": "articles/what-happens-when-address-expires.html",
    "title": "ماذا يحدث عند انتهاء صلاحية البريد المؤقت؟ دورة التلف المشفر ومسح الذاكرة الحية 100% | FreeTemp.email — بريد مؤقت",
    "rel": "articles/what-happens-when-address-expires.html"
  },
  {
    "name": "articles/how-to-generate-address.html",
    "title": "كيفية توليد عنوان بريد مؤقت جديد عالي العشوائية وتغييره بنقرة واحدة | FreeTemp.email — بريد مؤقت",
    "rel": "articles/how-to-generate-address.html"
  },
  {
    "name": "articles/how-to-copy-address.html",
    "title": "نسخ عنوان البريد المؤقت بدقة وبدون مسافات خفية: تجنب أخطاء استمارات التسجيل | FreeTemp.email — بريد مؤقت",
    "rel": "articles/how-to-copy-address.html"
  },
  {
    "name": "articles/how-to-receive-otp.html",
    "title": "كيفية استقبال واستخراج أكواد التحقق (OTP) بنقرة واحدة وتفادي انتهاء مهلة الرمز | FreeTemp.email — بريد مؤقت",
    "rel": "articles/how-to-receive-otp.html"
  },
  {
    "name": "articles/how-to-open-verification-links.html",
    "title": "كيفية فتح روابط التحقق بأمان وحجب بكسلات التتبع وإعادة التوجيه الملغومة | FreeTemp.email — بريد مؤقت",
    "rel": "articles/how-to-open-verification-links.html"
  },
  {
    "name": "articles/temporary-email-for-software-testing.html",
    "title": "استخدام البريد المؤقت في اختبارات البرمجيات المؤتمتة (QA & E2E) عبر Playwright و Cypress | FreeTemp.email — بريد مؤقت",
  ...
  },
  {
    ...
    "title": "منع تسريب البيانات وهجمات حشو بيانات الاعتماد (Credential Stuffing) عبر البريد المؤقت | FreeTemp.email — بريد مؤقت",
  ...
  },
  {
    ...
    "title": "البريد المؤقت السريع مقابل الأسماء المستعارة الدائمة (Aliases): متى تستخدم كلاً منهما؟ | FreeTemp.email — بريد مؤقت",
    "rel": "articles/disposable-email-vs-permanent-aliases.html"
  },
  {
    "name": "articles/protecting-privacy-under-gdpr-ccpa.html",
    "title": "حماية الخصوصية الرقمية والحق في النسيان: الامتثال العملي لقوانين GDPR و CCPA عبر البريد المؤقت | FreeTemp.email — بريد مؤقت",
    "rel": "articles/protecting-privacy-under-gdpr-ccpa.html"
  },
  {
    "name": "articles/combating-marketing-trackers-and-spy-pixels.html",
    "title": "كشف بكسلات التجسس وحجب تعقب فتح رسائل البريد الإلكتروني: كيف تحمي خوادمنا الحافة هويتك؟ | FreeTemp.email — بريد مؤقت",
    "rel": "articles/combating-marketing-trackers-and-spy-pixels.html"
  },
  {
    "name": "articles/temporary-mail-for-free-trials-and-saas.html",
    "title": "كيفية تجربة خدمات SaaS والفترات المجانية بأمان دون فخاخ التجديد ورسائل الترويج المزعجة | FreeTemp.email — بريد مؤقت",
    "rel": "articles/temporary-mail-for-free-trials-and-saas.html"
  },
  {
    "name": "articles/secure-two-factor-authentication-workflows.html",
    "title": "المصادقة الثنائية 2FA: مقارنة أمان الرسائل القصيرة SMS مقابل البريد المؤقت ونموذج التهديد | FreeTemp.email — بريد مؤقت",
    "rel": "articles/secure-two-factor-authentication-workflows.html"
  },
  {
    "name": "articles/developer-guide-headless-testing-api.html",
    "title": "دليل المطورين: الربط البرمجي واستقبال الرسائل عبر Webhooks و REST API في بيئات الاختبار | FreeTemp.email — بريد مؤقت",
    "rel": "articles/developer-guide-headless-testing-api.html"
  },
  {
    "name": "articles/understanding-disposable-email-blocklists.html",
    "title": "القوائم السوداء للبريد المؤقت: كيف تصنف الخدمات العناوين وما استراتيجيتنا لضمان القبول؟ | FreeTemp.email — بريد مؤقت",
    "rel": "articles/understanding-disposable-email-blocklists.html"
  },
  {
    "name": "articles/zero-knowledge-inbox-architecture.html",
    "title": "معمارية المعرفة الصفرية (Zero-Knowledge): تخزين متطاير في الذاكرة الحية بدون أقراص صلبة | FreeTemp.email — بريد مؤقت",
    "rel": "articles/zero-knowledge-inbox-architecture.html"
  },
  {
    "name": "articles/avoiding-phishing-and-malicious-payloads.html",
    "title": "تعقيم محتوى البريد الإلكتروني وحماية المتصفح من حمولات التصيد الخبيثة والأكواد الملغومة | FreeTemp.email — بريد مؤقت",
    "rel": "articles/avoiding-phishing-and-malicious-payloads.html"
  },
  {
    "name": "articles/e-commerce-privacy-and-price-discrimination.html",
    "title": "التمييز في أسعار المتاجر الإلكترونية وحماية الخصوصية المالية: كيف يحميك البريد المؤقت من رفع الأسعار؟ | FreeTemp.email — بريد مؤقت",
    "rel": "articles/e-commerce-privacy-and-price-discrimination.html"
  },
  {
    "name": "articles/multi-device-inbox-sync-and-pwa.html",
    "title": "المزامنة المؤقتة متعددة الأجهزة وتطبيقات الويب التقدمية (PWA): خصوصية فورية على الهاتف والكمبيوتر | FreeTemp.email — بريد مؤقت",
